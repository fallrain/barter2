		...
		<view class="bt2-houseApply-card">
			...
			<ul class="bt2-houseApply-card-cnt">
				<li class="bt2-houseApply-card-item">
					<b-item :required="true" title="筑家负责人" :right="false">
						<template v-slot:middle>
							<input class="uni-input" placeholder-style="color:#999999;line-height:56upx" @blur="nameEnd()" v-model="name"
				...
				<li class="bt2-houseApply-card-item uni-column">
					...
					<input class="uni-input" placeholder-style="color:#999999;line-height:56upx" type="number" maxlength="11" @blur="telEnd()"
					 v-model="tel" placeholder="请输入" />
				</li>
			</ul>
		</view>
		<view class="bt2-houseApply-card">
			...
			<ul class="bt2-houseApply-card-cnt">
				<li class="bt2-houseApply-card-item">
					...
					<li class="bt2-houseApply-card-item uni-column">
						...
						<input class="uni-input-time" placeholder-style="color:#999999;line-height:56upx" placeholder="结束时间" @click="endTimeSelect()"
						 v-model="endTime" />
					</li>
					<li class="bt2-houseApply-card-item">
						<span class="bt2-houseApply-card-item-star">*</span>
		...
		methods: {
			...
			nextPage() {
				...
				this.hGet('barter-builthouse/buildHouse/saveShopInfo', {
					...
					inIndustryPic: JSON.stringify(this.checkedIndustry)
				}).then(data => {
					if (data) {
						console.log(data)
					}
  ...
  <view>
    <view class="bt2-houseApply-card">
      ...
      <ul class="bt2-houseApply-card-cnt">
        ...
        <li class="bt2-houseApply-card-item uni-column">
          <text class="bt2-houseApply-card-item-name">手机号码</text>
          <input class="uni-input" placeholder-style="color:#999999;line-height:56upx" type="number" maxlength="11"
                 @blur="telEnd()" v-model="tel" placeholder="请输入"/>
        </li>
      </ul>
    </view>
    <view class="bt2-houseApply-card">
      ...
      <ul class="bt2-houseApply-card-cnt">
        ...
        <li class="bt2-houseApply-card-item uni-column">
          ...
          <input class="uni-input-time" placeholder-style="color:#999999;line-height:56upx" placeholder="结束时间"
                 @click="endTimeSelect()" v-model="endTime"/>
        </li>
        <li class="bt2-houseApply-card-item">
          <span class="bt2-houseApply-card-item-star">*</span>
          <text class="bt2-houseApply-card-item-name">入驻产业</text>
        ...
        <li class="bt2-houseApply-card-item-mult bt2-houseApply-card-item">
          <b-multrow-checkbox :list="items3" :checkedIds.sync="industryIds"
                              :checkboxChange1="checkboxChange"></b-multrow-checkbox>
        </li>
      </ul>
      <view class="mt16" v-for="(industry,index) in checkedIndustry" :key="index">
        <ul class="bt2-houseApply-card-cnt">
          ...
          <ss-upload-image :url="url" :file-list="fileMap[industry.id]" :name="imgName" @on-success="onSuccess"
...
>>>>>>> fc7432b747259991eb0f07a35da2dc11f9af634c
</style>
